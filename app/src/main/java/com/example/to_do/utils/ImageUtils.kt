...
class ImageUtils(private val activity: ProfileFragment)  {
    ...
    fun launchGallery(context: ProfileFragment) {
        ...
        if (ContextCompat.checkSelfPermission(context.requireContext(), permission) != PackageManager.PERMISSION_GRANTED) {
